...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified',])->group(function () {
    ...
    Route::get('/manager/order', [OrderController::class, 'index'])->name('manage.order');
    ...
    Route::get('/order/invoice/download/{id}', [OrderController::class, 'orderInvoiceDownload'])->name('order.invoice.download');
});
