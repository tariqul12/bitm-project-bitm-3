                ...
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <div class="register-form">
                        <div class="title">
                            ...
                            <p class="text-center text-danger text-bold">{{session('message')}}</p>
                        </div>
                        <form class="row" method="post" action="{{route('customer.register')}}">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{old('name')}}" name="name" type="text" id="reg-fn" required/>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="mobile" value="{{old('number')}}" type="number" id="reg-phone" required/>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
